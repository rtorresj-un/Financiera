...
```{r echo=FALSE,caption='Media condicional .',fig.pos='h',fig.height = 3, fig.width = 7, fig.align = "center", fig.show='hide'}
# media incondicional 
plot.new()
plot(na.omit(jp), main= "Media movil y exponencial tasa de cambio")
...
```
```{r echo=FALSE,caption='Media condicional .',fig.pos='h',fig.height = 3, fig.width = 7, fig.align = "center"}
...
plot(ret, main= "Media movil y exponencial retornos")
...
```{r echo=FALSE, fig.height = 3, fig.width = 5, fig.align = "center", warning = FALSE,fig.pos='h',message=FALSE}
rets<- ts(jp_r)
