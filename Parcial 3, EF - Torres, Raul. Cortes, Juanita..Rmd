...
texreg(extract.rugarch(garch11.fit, indep = jp_r, include.rsquared = FALSE), digits = 8, custom.coef.names = c("mu", "MA(1)", "omega", "alpha", "beta"), caption = "Resultados del modelo", custom.model.names = "sGARH(1,1)") #for latex # as R^2 is zero in this example.
...
```
```{r echo=FALSE, fig.height=2, fig.pos='h', fig.width=2, message=FALSE, ref.label="nic"}
...
```{r echo=FALSE, fig.align="center", fig.height=3, fig.pos='h', fig.width=7, message=FALSE}
...
```{r, echo=FALSE,fig.pos='h',fig.height = 3, fig.width = 7, fig.align = "center"}
rollfore <- ugarchroll(egarch11, jp_r, n.start = 2000, refit.every = 50,
...
Por otro lado, con la especificación escogida del modelo se obtuvo una cobertura promedio para el VaR de 4.6%, lo que indica que se sobreestimó ligeramente el riesgo de pérdida, frente a un nivel de confianza del 95%.
...
```{r , echo = FALSE, fig.height=2, fig.width=5, message=FALSE}
