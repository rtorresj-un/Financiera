...
```{r echo=FALSE, fig.align="center", fig.height=3, fig.pos='h', fig.width=5, message=FALSE, warning=FALSE}
grid.arrange(
...
lines(SMA(jp_r, n = 22), col = "darkgreen")
#Observar si hay un proceso de autocorrelación, si la media es cero, la varianza constante, etc.
```
```{r echo=FALSE,fig.pos='h',fig.height = 3, fig.width = 7, fig.align = "center"}
lines(EMA(jp_r, n = 22), col = "firebrick")
```
