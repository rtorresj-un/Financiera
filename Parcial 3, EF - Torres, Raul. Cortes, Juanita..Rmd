...
#rollapply(jp_r)
par(mfrow=c(3,1))
chart.RollingPerformance(jp_r08, width = 22, FUN = "sd.annualized", scale = 252, main = "One month rolling volatility")
chart.RollingPerformance(jp_r20, width = 22, FUN = "sd.annualized", scale = 252, main = "One month rolling volatility")
