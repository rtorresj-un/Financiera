...
```{r echo=FALSE, fig.align="center", fig.height=5, fig.pos='h', fig.width=3, message=FALSE, warning=FALSE}
grid.arrange(
...
```{r echo=FALSE, fig.height = 5, fig.width = 3, fig.align = "center", warning = FALSE,fig.pos='h',message=FALSE}
grid.arrange(
