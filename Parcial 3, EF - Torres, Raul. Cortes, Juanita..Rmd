...
```{r echo=FALSE, fig.height = 2, fig.width = 4, fig.align = "center", warning = FALSE,fig.pos='h',message=FALSE}
...
# media incondicional
#plot(na.omit(jp), main= "Media movil y exponencial USD/JPY", type='l', legend=TRUE)
#lines(SMA(Cl(na.omit(jp)), n = 22), col = "darkgreen")
...
#lines(EMA(Cl(na.omit(jp)), n = 22), col = "firebrick")
...
Es necesario modelar la media de los retornos de la tasa de cambio, debido a la presencia de fluctuaciones con respecto a la media de largo plazo (SMA en verde y EMA en rojo).
...
```{r}
rollfore <- ugarchroll(ar1egarch11, jp_r, n.start = 2000, refit.every = 3,
