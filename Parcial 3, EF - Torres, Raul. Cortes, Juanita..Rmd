...
```{r echo=FALSE ,message=FALSE, results = 'asis',fig.pos='h',fig.align = "center"}
...
```{r echo=FALSE, message=FALSE, results = 'asis',fig.pos='h',fig.height = 3, fig.width = 3, fig.align = "center"}
